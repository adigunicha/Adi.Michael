...
const Home = () => {
  ...
  const {darkmode} = useContext(Darkmode)
    return ( 
      ...
      className={`${darkmode ? "bg-black text-white" : "bg-white text-black "}  font-secondary pt-[100px] pb-5  px-[10px] md:pt-[200px] md:pl-[100px]`}>
            <div className="flex md:grid md:grid-cols-2  flex-col-reverse">
                <motion.div initial={{opacity:0,y:'-50%'}} animate={{opacity:1,y:0}} transition={transition1} className="flex mt-10 md:mt-0  gap-5 flex-col">
