   ...
   const sendEmail = (e) => {
    ...
    return ( 
      <motion.div   initial={{opacity:0,y:'50%'}} transition={transition1} animate={{opacity:1,y:0}} className={`${darkmode ? "bg-black text-white" : "bg-white text-black"} overflow-x-hidden `} >
        <section className=" relative font-secondary pt-[100px] pb-3 px-[10px] md:pt-[160px] md:pl-[100px]">
           <div className="flex  border-b-2 mr-5 border-gray-200 pb-5 md:pb-10 md:gap-5 gap-3 items-center">
                 ...
                 <div className="grid pt-14 gap-16 relative md:gap-28 md:grid-cols-2">
                   <div>
                     <form ref={form} onSubmit={sendEmail} className=" space-y-10">
                        ...
                        <input className={`md:w-[600px] w-[90vw] ${darkmode ? "border-gray-400 bg-black" : "border-black"}   h-[30px] p-5 border-0 border-b-2 outline-none `} type="email" placeholder="Email" required name="from_email"/>
